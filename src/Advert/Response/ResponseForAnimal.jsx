...
class ResponseForAnimal extends Component {
        ...
        return (
            <div className="response"
                ...
                <div className="response__email">
                    ...
                    <button 
                        disabled={this.state.isDisabled || this.state.phoneNumber.length !== this.AMOUNT_PHONE_NUMBERS || !this.state.email.match(this.REG_EXP)}
...
export default ResponseForAnimal;